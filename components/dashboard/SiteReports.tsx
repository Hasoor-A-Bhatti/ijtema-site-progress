    ...
    <div className="p-3 sm:p-6">
      ...
      <section className="mt-4 sm:mt-5">
        ...
        */}
        ...
        {/* Keep filter/header visible on desktop
            even when a department is selected.
        */}
        {selectedDepartmentId && (
          <div className="hidden xl:flex xl:items-end xl:justify-between xl:gap-4">
            ...
            <div className="flex flex-col gap-2">
              <input
                ...
                placeholder="Search department or Nazim..."
                className="h-11 w-[280px] rounded-xl border border-slate-300 bg-white px-3 text-base"
              />
